...
\begin{frame}{Different parameters give different model results}
    \[I = C_m\frac{{\mathrm d} V_m}{{\mathrm d} t}  + {\bf\color{blue}I_{K}} + {\bf\color{green}I_{Na}} + {\bf\color{red}I_{l}}\]
    \vspace{-5mm}
    \begin{figure}
   {\includegraphics[width=1\textwidth]{hh_basic.png}}
   \end{figure}
...
\begin{frame}{Solution: Perform an uncertainty quantification, which relates uncertain input to uncertain output}
    \begin{figure}
      %  \only<1>{\includegraphics[width=0.6\textwidth]{model2.png}}
       {\includegraphics[width=0.6\textwidth]{model3.png}}
