...
\begin{frame}{\onslide<1->{Point wise comparison \onslide<2->{can be problematic since "the same" spike can occur at different times when varying the parameters}}}
   \vspace{-5mm}
   \begin{figure}
